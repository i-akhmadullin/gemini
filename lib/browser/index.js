...
module.exports = inherit({
    ...
    open: function(url) {
        ...
        return this._resetCursor()
            ...
            .then(function() {
                return _this._browser.execute(_this._polyfill);
            })
            .then(function() {
    ...
    calibrate: function() {
        var _this = this;
        return this._browser.get('http://bem.github.io/gemini/calibrate.html')
            .then(function() {
                /*jshint evil:true*/
                return [
                    _this._browser.eval(clientScriptCalibrate),
                    _this.captureFullscreenImage()
                ];
            })
            .spread(function(pageData, image) {
                ...
                _this._calibration = {
                    ...
                    capturesEntirePage: height >= pageData.bodyHeight
                };
    ...
    _prepareScreenshotCommand: function(selectors, opts) {
        if (this._calibration) {
            opts = extend({}, opts, {
                needsScrolling: !this._calibration.capturesEntirePage
            });
        }
